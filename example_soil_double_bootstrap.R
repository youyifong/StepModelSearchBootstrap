...
cvg = lapply(1:2, function(i) {
    ...
    out=sapply(1:1000, function(b) {
        ...
        sapply(mm, function(m) {
            fit=chngptm(formula.1=f, formula.2=~midsoil_anom, dat.b, type="step", family="gaussian", est.method="fastgrid2", var.type="bootstrap", subsampling=m, ci.bootstrap.size=510, ncpus=30)
